...
hero:
  ...
  tagline: Um Roadmap para os que desejam entrar no campo de Machine Learning, criado pelo Time Visão da Universidade de Pernambuco.
  actions:
    - theme: brand
      text: Roadmap
      link: /boas-vindas
    - theme: alt
      text: Site do Time Visão

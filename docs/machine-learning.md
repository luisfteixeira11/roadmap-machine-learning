...
Para mergulhar de fato no Aprendizado de Máquina é necessário saber de que forma as máquinas aprendem e como que acontece por trás das principais bibliotecas de aprendizado de máquina. Por isso eu vou mudar um pouco a estrutura do roadmap nessa página com a finalidade de um destaque melhor para cada tópico.
...
- [Vídeo Didática Tech com conteúdo prático sobre o Aprendizado por Reforço.](https://youtu.be/Bn6kIArpd3Q?si=phFGbhf9ARomo5Wf)
...
- [Artigo da Web sobre métricas populares de avaliação.](https://mariofilho.com/as-metricas-mais-populares-para-avaliar-modelos-de-machine-learning/)
- [Playlist do Youtube do canal Fernando dos Santos sobre avaliação de modelos.](https://youtube.com/playlist?list=PLPrYObOisEDGuRtQXpXtUOxx2GO7qfjRF&si=cl9Q2YgKi90Z5XtS)
